...
<div class="page-header" style="background: url(img/banner1.jpg);">
    ...
    <h3><a href="#">Deborah Ennin</a></h3>
    <span><i class="lni-phone-handset"></i>0245751349</span>
    </div>
    </div>
    ...
    <a href="#"><img src="{{asset('img/details/img1.jpg')}}" alt="" /></a>
    </div>
    <div class="widget-content">
    <h4><a href="#">hand bag</a></h4>
     <div class="meta-tag">
    <span>
    <a href="#"><i class="lni-user"></i> Mubarak</a>
    </span>
    <span>
    <a href="#"><i class="lni-map-marker"></i> Takoradi</a>
    </span>
    <span>
    <a href="#"><i class="lni-tag"></i> gucci</a>
    </span>
    </div>
    <h4 class="price">180.00 cedis</h4>
    </div>
    <div class="clearfix"></div>
    </li>
    <li>
    <div class="widget-thumb">
    <a href="#"><img src="{{asset('img/details/img2.jpg')}}" alt="" /></a>
    </div>
    <div class="widget-content">
    <h4><a href="#">Utensil</a></h4>
    <div class="meta-tag">
    <span>
    <a href="#"><i class="lni-user"></i> Richard Blankson</a>
    </span>
    <span>
    <a href="#"><i class="lni-map-marker"></i> Saltpond, Ghana</a>
    </span>
    <span>
    <a href="#"><i class="lni-tag"></i> Shiny</a>
    </span>
    </div>
    <h4 class="price">450.00 cedis</h4>
    </div>
    <div class="clearfix"></div>
    </li>
    <li>
    <div class="widget-thumb">
    <a href="#"><img src="{{asset('img/details/img3.jpg')}}" alt="" /></a>
    </div>
    <div class="widget-content">
    <h4><a href="#">T shirt</a></h4>
    <div class="meta-tag">
    <span>
    <a href="#"><i class="lni-user"></i> Kipo </a>
    </span>
    <span>
    <a href="#"><i class="lni-map-marker"></i> Accra, Ghana</a>
    </span>
    <span>
    <a href="#"><i class="lni-tag"></i> Polo</a>
    </span>
    </div>
    <h4 class="price">480.00 cedis</h4>
    </div>
    <div class="clearfix"></div>
    </li>
    <li>
    <div class="widget-thumb">
    <a href="#"><img src="{{asset('img/details/img4.jpg')}}" alt="" /></a>
    </div>
    <div class="widget-content">
    <h4><a href="#">Washing Powder</a></h4>
    <div class="meta-tag">
    <span>
    <a href="#"><i class="lni-user"></i> Adwoa Sarpong</a>
    </span>
    <span>
    <a href="#"><i class="lni-map-marker"></i> Sunyani</a>
    </span>
    <span>
    <a href="#"><i class="lni-tag"></i> So Klin</a>
    </span>
    </div>
    <h4 class="price">480.00 cedis</h4>
    </div>
    ...
    <li>
    <div class="widget-thumb">
    <a href="#"><img src="{{asset('img/details/img5.jpg')}}" alt="" /></a>
    </div>
    <div class="widget-content">
    <h4><a href="#">Television set</a></h4>
    <div class="meta-tag">
    <span>
    <a href="#"><i class="lni-user"></i> John Adams</a>
    </span>
    <span>
     <a href="#"><i class="lni-map-marker"></i> Kumasi</a>
    </span>
    <span>
    <a href="#"><i class="lni-tag"></i> Nasco</a>
    </span>
    </div>
    <h4 class="price">480.00 cedis</h4>
    </div>
