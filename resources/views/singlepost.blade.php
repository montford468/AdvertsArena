...
<div class="page-header" style="background: url(assets/img/banner1.jpg);">
    ...
    <a href="#"><img class="img-fluid" src="{{asset('img/blog/blog1.jpg')}}" alt=""></a>
    ...
    <h2 class="post-title"><a href="/singlepost">Eum Iriure Dolor Duis Autem</a></h2>
    <div class="meta">
    <span class="meta-part"><a href="#"><i class="lni-user"></i> Adverts Arena</a></span>
    <span class="meta-part"><a href="#"><i class="lni-alarm-clock"></i> June 21, 2021</a></span>
    ...
    <a href="#">
    <img class="img-fluid" src="{{asset('img/blog/user1.jpg')}}" alt="">
    </a>
    </div>
    <div class="info-body">
    <div class="media-heading">
    <h4 class="name">Ama Atta</h4>
    <span class="comment-date"><i class="lni-alarm-clock"></i> July 12, 2021</span>
    ...
    <div class="thumb-left">
    <a href="#">
    <img class="img-fluid" src="{{asset('img/blog/user2.jpg')}}" alt="">
    </a>
    </div>
    <div class="info-body">
    <div class="media-heading">
    <h4 class="name">Albert Osei</h4>
    <span class="comment-date"><i class="lni-alarm-clock"></i> July 2, 2021</span>
    <a href="#" class="reply-link"><i class="lni-reply"></i> Reply</a>
    </div>
    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officiis, nemo ipsam eum illo minus voluptatibus ipsa nulla, perferendis aliquid aperiam beatae nihil sapiente eaque atque nesciunt perspiciatis ex saepe, quibusdam..</p>
    </div>
    ...
    <div class="thumb-left">
    <a href="#">
    <img class="img-fluid" src="{{asset('img/blog/user3.jpg')}}" alt="">
    </a>
    </div>
    <div class="info-body">
    <div class="media-heading">
    <h4 class="name">Stephen Appiah</h4>
    <span class="comment-date"><i class="lni-alarm-clock"></i> July 21, 2021</span>
    <a href="#" class="reply-link"><i class="lni-reply"></i> Reply</a>
    </div>
    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officiis, nemo ipsam eum illo minus voluptatibus ipsa nulla, perferendis aliquid aperiam beatae nihil sapiente eaque atque nesciunt perspiciatis ex saepe, quibusdam..</p>
    </div>
    ...
    <a href="#"><img src="{{asset('img/blog/thumb1.jpg')}}" alt="" /></a>
    </div>
    <div class="widget-content">
    <a href="#">Eum Iriure Dolor Duis Autem</a>
    <span><i class="icon-calendar"></i>June 29, 2021</span>
    </div>
    <div class="clearfix"></div>
    </li>
    <li>
    <div class="widget-thumb">
    <a href="#"><img src="{{asset('img/blog/thumb2.jpg')}}" alt="" /></a>
     </div>
    <div class="widget-content">
    <a href="#">Consectetuer Adipiscing Elit</a>
    <span><i class="icon-calendar"></i>June 24, 2021</span>
    </div>
    <div class="clearfix"></div>
    </li>
    <li>
    <div class="widget-thumb">
    <a href="#"><img src="{{asset('img/blog/thumb3.jpg')}}" alt="" /></a>
    </div>
    <div class="widget-content">
    <a href="#">Et Leggings Fanny Pack</a>
    <span><i class="icon-calendar"></i>June 22, 2021</span>
    </div>
    <div class="clearfix"></div>
    </li>
    <li>
    <div class="widget-thumb">
    <a href="#"><img src="{{asset('img/blog/thumb4.jpg')}}" alt="" /></a>
    </div>
    <div class="widget-content">
    <a href="#">Exercitation Photo Booth</a>
    <span><i class="icon-calendar"></i>June 16, 2021</span>
    </div>
    <div class="clearfix"></div>
    </li>
    <li>
    <div class="widget-thumb">
    <a href="#"><img src="{{asset('img/blog/thumb5.jpg')}}" alt="" /></a>
    </div>
    <div class="widget-content">
    <a href="#">Eum Iriure Dolor Duis Autem</a>
    <span><i class="icon-calendar"></i>June 9, 2021</span>
    </div>
    <div class="clearfix"></div>
    </li>
    </ul>
