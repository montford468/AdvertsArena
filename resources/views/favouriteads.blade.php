...
<div class="page-header" style="background: url(assets/img/banner1.jpg);">
    ...
    <li>
    <a class="active" href="/favouriteads">
    <i class="lni-heart"></i>
    ...
    <td class="photo"><img class="img-fluid" src="{{asset('img/product/img1.jpg')}}" alt=""></td>
    <td data-title="Title">
    ...
    <td class="photo"><img class="img-fluid" src="{{asset('img/product/img2.jpg')}}" alt=""></td>
    <td data-title="Title">
    ...
    <td class="photo"><img class="img-fluid" src="{{asset('img/product/img3.jpg')}}" alt=""></td>
    <td data-title="Title">
    ...
    <td class="photo"><img class="img-fluid" src="{{asset('img/product/img4.jpg')}}" alt=""></td>
    <td data-title="Title">
    ...
    <td class="photo"><img class="img-fluid" src="{{asset('img/product/img5.jpg')}}" alt=""></td>
    <td data-title="Title">
    ...
    <td class="photo"><img class="img-fluid" src="{{asset('img/product/img10.jpg')}}" alt=""></td>
    <td data-title="Title">
    ...
    <td class="photo"><img class="img-fluid" src="{{asset('img/product/img7.jpg')}}" alt=""></td>
    <td data-title="Title">
    <h3>Infinix Phone 8GB Unlocked with Dual Camera</h3>
    <span>Ad ID: ng3D5hAMHPajQrM</span>
    </td>
    <td data-title="Category">Mobile</td>
    ...
    <td class="photo"><img class="img-fluid" src="{{asset('img/product/img8.jpg')}}" alt=""></td>
    <td data-title="Title">
    ...
    <td class="photo"><img class="img-fluid" src="{{asset('img/product/img9.jpg')}}" alt=""></td>
    <td data-title="Title">
