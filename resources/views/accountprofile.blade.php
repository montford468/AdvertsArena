...
<div class="page-header" style="background: url(assets/img/banner1.jpg);">
    ...
    <li>
    <a class="active" href="/profilesetting">
    <i class="lni-cog"></i>
    ...
    <option value="none">Ghana</option>
    <option value="none">Nigeria</option>
    <option value="none">Togo</option>
     <option value="none">Ivory Coast</option>
    <option value="none">senegal</option>
